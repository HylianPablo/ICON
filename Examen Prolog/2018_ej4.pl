%Cambiar la solucion anterior para que el metainterprete evalúe de derecha a izquierda las cláusulas componentes de una regla.
...
solveP(true,_):-!.
solveP((A,B),P):-!,solveP(B,P),solveP(A,P).
